...
We can choose the best linear model by comparing the Akaike Information Criterion (AIC). We use the function "dredge" from the package "MuMIn" to rank all the possible models by their AIC
```{r}
